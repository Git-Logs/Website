...
export default async function Page(props: {
  ...
  return (
    <>
      <div
        className="container py-12 border rounded-xl md:px-8"
        style={{
      ...
      <article className="container flex flex-col justify-between gap-4 px-0 py-8 lg:flex-row lg:px-4">
        <div className="flex-1 min-w-0 p-4 prose">
        ...
        <div className="flex flex-col gap-4 border-l p-4 text-sm lg:w-[250px]">
          ...
          <div>
            <p className="mb-1 text-sm text-fd-muted-foreground">Written on</p>

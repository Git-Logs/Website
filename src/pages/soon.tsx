...
export default function NotFound() {
    return (
      <>
                <Metas
                   title="Soon • Git Logs"
                   description="This page is not available yet. Check back later."
                        ...
                        <main className="px-4 mx-auto mt-10 w-full max-w-7xl sm:px-6 sm:mt-12 md:mt-16 lg:px-8 lg:mt-20 xl:mt-28">
                            <div className="sm:text-center lg:text-center">
                                ...
                                <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:text-md md:mt-5 md:text-md lg:mx-0 font-fredoka">
                                    Whatever you think should be here is a feature that we have not released yet. Please check back later or join our server for news and updates
                                </p>
                            </div>
